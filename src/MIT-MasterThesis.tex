...
\usepackage{../templates/phdThesisFormat}      				%%  This is the sty file that is to be used to generate the 	
...
\advisorInstitution{Instituto Tecnol\'ogico y de Estudios Superiores de Occidente}           		 %%  Your advisor's institution
\committeeMemberA{Committee member A's name}                   	     %%  Committee member A's name
\committeeMemberAInstitution{Committee member A's institution}    	 %%  Committee membhttps://github.com/braulioisaacmtz/iteso_latex_thesis.giter A's institution
...
\dissertationMonth{Jan}                                              %%  The month when you give your thesis
\dissertationYear{2025}                                         	 %%  The year when you give your thesis
\dissertationLocation{Guadalajara, Jalisco}                          %%  The location of your dissertation
...
\major{Electronics Design}                                      	 %%  Your major
...
\bibliography{../references/References.bib}                          %%  This is a bib file with te bibliography for your dissertation
...
\insertChapter{./chapters/Chapter_01}
\insertChapter{./chapters/Chapter_02}
\appendix        													%%  This command is needed before you start inserting your 
																	%%	appendices for proper formatting.
\insertChapter{./chapters/Appendix_01}
